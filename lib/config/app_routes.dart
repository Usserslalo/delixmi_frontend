...
class AppRoutes {
  ...
  static const String ownerOrdersList = '/owner_orders_list';
  static const String ownerMetrics = '/owner_metrics';
  static const String ownerTransactions = '/owner_transactions';
